        ...
        <form action="{{ route('jobs.store') }}" method="POST" class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" placeholder="e.g. +91 9876543210"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="payment" name="payment" value="{{ old('payment') }}" placeholder="e.g. 50000 INR"
