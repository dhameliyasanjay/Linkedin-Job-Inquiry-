...
<div class="max-w-2xl mx-auto flex flex-col gap-6">
    <div class="flex items-center gap-2">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-[#1b1b18] dark:text-[#EDEDEC]">Add New Position</h1>
    </div>
    ...
    <div class="bg-white dark:bg-[#161615] p-6 rounded-lg border border-[#19140035] dark:border-[#3E3E3A] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.06)]">
        <form action="{{ route('positions.store') }}" method="POST" class="flex flex-col gap-6">
            @csrf
